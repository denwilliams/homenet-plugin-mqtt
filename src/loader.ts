...
import { Dict, IPluginLoader, ILogger, IConfig, IClassTypeFactory, IButtonManager, ISensorManager, IButton, ISensor } from '@homenet/core';
import * as mqtt from 'mqtt';

export function create(annotate): { MqttPluginLoader: new(...args: any[]) => IPluginLoader } {
  @annotate.plugin()
  class MqttPluginLoader implements IPluginLoader {
    ...
    constructor(
            ...
            @annotate.service('ISensorManager') sensors: ISensorManager,
